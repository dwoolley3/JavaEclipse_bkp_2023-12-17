...
public class SRM563_Div2_L1_FoxAndHandleEasy
{
	public String isPossible(String S, String T)
	{
		...
		for (int i = 0; i < n; i++)
		{
			...
			//if (sb.insert(i,S).toString().equals(T)) return "Yes";
		}
		return "No";
	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, String p0, String p1, boolean hasAnswer, String p2) {
		...
		System.out.println("]");
		SRM563_Div2_L1_FoxAndHandleEasy obj;
		String answer;
		obj = new SRM563_Div2_L1_FoxAndHandleEasy();

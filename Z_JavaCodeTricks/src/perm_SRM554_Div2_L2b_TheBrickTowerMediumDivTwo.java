...
public class perm_SRM554_Div2_L2b_TheBrickTowerMediumDivTwo
{
	private boolean[] used;
	private int outIndex = 0, n;
	...
	//Generate permutations of 0...n-1 in per[] in lexiographical order
	public void permute(int[] h)
	{
		if (outIndex == n)
		{
			int cnt = 0;
			for (int i = 0; i < n-1; i++)
				cnt += Math.max(h[per[i]], h[per[i+1]]);
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, boolean hasAnswer, int[] p1) {
		...
		System.out.print("}");
		System.out.println("]");
		perm_SRM554_Div2_L2b_TheBrickTowerMediumDivTwo obj;
		int[] answer;
		obj = new perm_SRM554_Div2_L2b_TheBrickTowerMediumDivTwo();

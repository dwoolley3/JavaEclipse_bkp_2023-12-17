...
public class bs_SRM615_Div2_L2a_LongLongTripDiv2
{
	public String isAble(long D, int T, int B)
	{
		long right =  D / B, left = 0;

        while (left <= right)
        {
    		long mid = (right + left) / 2;
        	long val = mid + (D - mid * B);
        	if (val == T) return "Possible";
	...
	private static boolean KawigiEdit_RunTest(int testNum, long p0, int p1, int p2, boolean hasAnswer, String p3) {
		...
		System.out.println("]");
		bs_SRM615_Div2_L2a_LongLongTripDiv2 obj;
		String answer;
		obj = new bs_SRM615_Div2_L2a_LongLongTripDiv2();

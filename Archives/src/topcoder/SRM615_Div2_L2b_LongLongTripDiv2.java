...
public class SRM615_Div2_L2b_LongLongTripDiv2
{
	public String isAble(long D, int T, int B)
	{
		long x = (D-T) / (B-1);
		if (x <= T && x >= 0 && (D-T) % (B-1) == 0)
			return "Possible";
		return "Impossible";
	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, long p0, int p1, int p2, boolean hasAnswer, String p3) {
		...
		System.out.println("]");
		SRM615_Div2_L2b_LongLongTripDiv2 obj;
		String answer;
		obj = new SRM615_Div2_L2b_LongLongTripDiv2();

...
public class nCr_SRM730_Div2_L2_ExpectedMinimumPowerDiv2
{
   ...
   long[][] generateBinomialCoefficients(int n) {
	...
	private static boolean KawigiEdit_RunTest(int testNum, int p0, int p1, boolean hasAnswer, double p2) {
		...
		System.out.println("]");
		nCr_SRM730_Div2_L2_ExpectedMinimumPowerDiv2 obj;
		double answer;
		obj = new nCr_SRM730_Div2_L2_ExpectedMinimumPowerDiv2();

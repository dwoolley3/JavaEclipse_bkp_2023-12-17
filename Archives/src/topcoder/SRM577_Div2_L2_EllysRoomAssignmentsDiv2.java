...
public class SRM577_Div2_L2_EllysRoomAssignmentsDiv2
{
	public double getProbability(String[] ratings)
	{
		String ra = "";
		for (String st : ratings) ra += st;
		String[] s = ra.split(" ");
		int n = s.length;
		...
		int pos = 0;
		while (pos < n && a[pos] != e) pos++;
		
		double prob = 0;
		if (r == 1 || pos == 0) prob = 1;
		else if (pos < r) prob = 0;
		else
			prob = 1.0 / r;
		return prob;
	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, String[] p0, boolean hasAnswer, double p1) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM577_Div2_L2_EllysRoomAssignmentsDiv2 obj;
		double answer;
		obj = new SRM577_Div2_L2_EllysRoomAssignmentsDiv2();

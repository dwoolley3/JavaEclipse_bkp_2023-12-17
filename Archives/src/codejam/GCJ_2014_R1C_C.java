...
public class GCJ_2014_R1C_C
{	
	FastReader in;
	PrintWriter out;
	
	public static void main(String[] args)  {
		new GCJ_2014_R1C_C().runWithFiles();
	}
	...
	void runWithFiles() {
		...
		//in = new FastReader(new File("src/C-small-attempt0.in"));
		//in = new FastReader(new File("src/C-large.in"));
		try {
			out = new PrintWriter(new File("src/C-ex.out"));
			//out = new PrintWriter(new File("src/C-small-attempt0.out"));

...
public class SRM614_Div2_L2_MinimumSquareEasy
{
	public long minArea(int[] x, int[] y)
	{
		...
		for (int j = 0; j < n-1; j++)
			for (int k = j+1; k < n; k++)
			{
				...
				long longside = Math.max(maxx-minx,maxy-miny) + 2;
				minArea = Math.min(minArea, longside*longside);
			}	
		return minArea;		
	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, int[] p1, boolean hasAnswer, long p2) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM614_Div2_L2_MinimumSquareEasy obj;
		long answer;
		obj = new SRM614_Div2_L2_MinimumSquareEasy();
	...
	public static void main(String[] args) {
		...
		// ----- test 1 -----
		p0 = new int[]{-2,-1,0,5,6};
		p1 = new int[]{-2,-1,0,5,6};
		p2 = 16L;

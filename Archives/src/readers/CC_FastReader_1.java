 ...
 */
//@NonThreadSafe
public final class CC_FastReader_1 {

    private final BufferedReader bufferedReader;
    /* legacy class preferred over String#split and Scanner for performance */
    private StringTokenizer tokenizer;

    private CC_FastReader_1(final BufferedReader bufferedReader) {
        this.bufferedReader = bufferedReader;
        this.tokenizer = null;
    }

    /**
     * Returns a {@link CC_FastReader_1} instance that reads input from {@code inputStream}.
     *
     * @param inputStream
     * @return Returns a {@link CC_FastReader_1} instance that reads input from {@code inputStream}.
     */
    public static final CC_FastReader_1 from(final InputStream inputStream) {
        return new CC_FastReader_1(new BufferedReader(new InputStreamReader(inputStream)));
    }

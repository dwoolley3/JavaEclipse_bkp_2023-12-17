...
public class SRM662_Div2_L1_Hexspeak_Alt
{
	public String decode(long ciphertext)
	{
		String d = Long.toHexString(ciphertext).toUpperCase();
		for (int i = 0; i < d.length(); i++)
			if (d.charAt(i) >= '2' && d.charAt(i) <= '9')
				return "Error!";
		d = d.replaceAll("1", "I");
		d = d.replaceAll("0", "O");
		return d;
	...
	private static boolean KawigiEdit_RunTest(int testNum, long p0, boolean hasAnswer, String p1) {
		...
		System.out.println("]");
		SRM662_Div2_L1_Hexspeak_Alt obj;
		String answer;
		obj = new SRM662_Div2_L1_Hexspeak_Alt();

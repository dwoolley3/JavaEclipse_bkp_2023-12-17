...
public class PartialSums_SRM636_Div1_L1_ChocolateDividingEasy
{
	//Time on 47x50 = 0.1 seconds instead of 7.84 seconds
	int[][] summ;
		...
		for (int c1 = 1; c1 < cols-1; c1++)
			for (int c2 = c1+1; c2 < cols; c2++)
				for (int r1 = 1; r1 < rows-1; r1++)
					...
					{
						sum[0] = getSum(1,   1, c1,  r1);
						sum[1] = getSum(c1+1,1, c2,  r1);
						sum[2] = getSum(c2+1,1, cols,r1);
						
						sum[3] = getSum(1,   r1+1, c1,  r2);
						sum[4] = getSum(c1+1,r1+1, c2,  r2);
						sum[5] = getSum(c2+1,r1+1, cols,r2);
						
						sum[6] = getSum(1,   r2+1, c1,  rows);
						sum[7] = getSum(c1+1,r2+1, c2,  rows);
						sum[8] = getSum(c2+1,r2+1, cols,rows);
...
//	private int getSum2(int x1, int y1, int x2, int y2, String[] s)
//	{
//		int sum = 0;
//		for (int c = x1; c <= x2; c++)
//			for (int r = y1; r <= y2; r++)
...
//	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, String[] p0, boolean hasAnswer, int p1) {
		...
		System.out.print("}");
		System.out.println("]");
		PartialSums_SRM636_Div1_L1_ChocolateDividingEasy obj;
		int answer;
		obj = new PartialSums_SRM636_Div1_L1_ChocolateDividingEasy();

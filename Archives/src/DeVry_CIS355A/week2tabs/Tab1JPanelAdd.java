...
public class Tab1JPanelAdd extends JPanel { // start class
	...
	public Tab1JPanelAdd()	{ // start constructor
		...
		jlbl_Title = new JLabel("Add 2 numbers", SwingConstants.CENTER);
		jpnl1_1_center = new JPanel();
		jpnl1_1_center.setLayout(new GridLayout(4, 2, 5, 5));
		jlbl_Num1 = new JLabel("Enter # 1 -->", SwingConstants.CENTER);
		jtxf_Num1 = new JTextField(6);
		jlbl_Num2 = new JLabel("Enter # 2 -->", SwingConstants.CENTER);

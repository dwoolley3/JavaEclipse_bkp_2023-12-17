 ...
 *  Iter supports the following two primary operations: add an edge to the graph,
 *  iterate over all of the vertices adjacent to a vertex. Iter also provides
...
public class Graph {
    ...
    public static void main(String[] args) {
        //In in = new In(args[0]);  //tinyG.txt
        In in = new In("src/algs4-data/tinyG.txt");

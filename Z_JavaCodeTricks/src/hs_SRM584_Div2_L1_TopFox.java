...
public class hs_SRM584_Div2_L1_TopFox
{
	public int possibleHandles(String familyName, String givenName)
	{
		...
		for (int i = 1; i <= familyName.length(); i++)
			...
			{
				String s = familyName.substring(0,i) + givenName.substring(0,j);
				hs.add(s);
			}
		return hs.size();
	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, String p0, String p1, boolean hasAnswer, int p2) {
		...
		System.out.println("]");
		hs_SRM584_Div2_L1_TopFox obj;
		int answer;
		obj = new hs_SRM584_Div2_L1_TopFox();

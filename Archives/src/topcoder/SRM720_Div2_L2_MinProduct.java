...
public class SRM720_Div2_L2_MinProduct
{
	public long findMin(int[] amount, int blank1, int blank2)
	{
		int b1 = blank1, b2 = blank2;
		if (blank1 > blank2)
		{
			b1 = blank2; b2 = blank1;
		}
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, int p1, int p2, boolean hasAnswer, long p3) {
		...
		System.out.println("]");
		SRM720_Div2_L2_MinProduct obj;
		long answer;
		obj = new SRM720_Div2_L2_MinProduct();
	...
	public static void main(String[] args) {
		...
		// ----- test 2 -----
		p0 = new int[]{2,6,0,0,0,0,0,0,0,0};
		p1 = 3;
		p2 = 3;
		p3 = 111L;
		all_right = KawigiEdit_RunTest(2, p0, p1, p2, true, p3) && all_right;

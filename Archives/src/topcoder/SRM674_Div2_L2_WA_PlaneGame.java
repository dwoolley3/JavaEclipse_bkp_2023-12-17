...
public class SRM674_Div2_L2_WA_PlaneGame
{
	public int bestShot(int[] x, int[] y)
	{
		int n = x.length, maxcnt = 0;
		for (int i = 0; i < n; i++)
			for (int j = 0; j < n; j++)
			{
				int cnt = 0;			
		...
		for (int i = 0; i < n; i++)
		{
			...
			if (x[i] == 0 && y[i] == 0)
				...
				for (int j = 0; j < n; j++)
					if (1L * y[i] * x[j] == 1L * x[i] * y[j]
					|| -1L * x[i] * x[j] == 1L * y[i] * y[j])
						cnt++;
			maxcnt = Math.max(cnt, maxcnt);
		}
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, int[] p1, boolean hasAnswer, int p2) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM674_Div2_L2_WA_PlaneGame obj;
		int answer;
		obj = new SRM674_Div2_L2_WA_PlaneGame();
	...
	public static void main(String[] args) {
		...
		// ----- test 1 -----
		p0 = new int[]{0,-1,900000,1,-900000,9};
		p1 = new int[]{0,2,450000,-2,-450000,10};
		p2 = 5;
		all_right = KawigiEdit_RunTest(1, p0, p1, true, p2) && all_right;
		// ------------------
		
		// ----- test 1 -----
		p0 = new int[]{1,-1,2,1,-2};
		p1 = new int[]{1,2,1,-2,-1};
		p2 = 4;
		all_right = KawigiEdit_RunTest(1, p0, p1, true, p2) && all_right;
		// ------------------

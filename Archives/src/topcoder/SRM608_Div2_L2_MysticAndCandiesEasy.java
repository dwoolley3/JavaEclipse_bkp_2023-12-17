...
public class SRM608_Div2_L2_MysticAndCandiesEasy
{
	...
	private static boolean KawigiEdit_RunTest(int testNum, int p0, int p1, int[] p2, boolean hasAnswer, int p3) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM608_Div2_L2_MysticAndCandiesEasy obj;
		int answer;
		obj = new SRM608_Div2_L2_MysticAndCandiesEasy();

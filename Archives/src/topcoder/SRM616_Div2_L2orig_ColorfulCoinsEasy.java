...
public class SRM616_Div2_L2orig_ColorfulCoinsEasy
{
	public String isPossible(int[] v)
	{
		...
		for (int a = 1; a < 10_000_001; a++)
		{
			...
			{
				int x = t / v[i];
				if (x == 0 || al.contains(x)) { ok = false; break; }
				al.add(x);
				t -= (x * v[i]);
			}
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, boolean hasAnswer, String p1) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM616_Div2_L2orig_ColorfulCoinsEasy obj;
		String answer;
		obj = new SRM616_Div2_L2orig_ColorfulCoinsEasy();
	...
	public static void main(String[] args) {
		...
		// ----- test 0 -----   //Takes 1.563s in TC machine; 1.390 sec on mine
		p0 = new int[]{1, 6, 42, 168, 672, 2688, 10752};
		p1 = "Impossible";

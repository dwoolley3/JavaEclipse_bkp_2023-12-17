...
public class SRM152_Div2_L1_FixedPointTheorem
{
	public double cycleRange(double R)
	{
        double fx, x = 0.25, min = Double.MAX_VALUE, max = Double.MIN_VALUE;
	...
	private static boolean KawigiEdit_RunTest(int testNum, double p0, boolean hasAnswer, double p1) {
		...
		System.out.println("]");
		SRM152_Div2_L1_FixedPointTheorem obj;
		double answer;
		obj = new SRM152_Div2_L1_FixedPointTheorem();

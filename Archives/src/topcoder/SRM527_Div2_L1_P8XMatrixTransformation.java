...
public class SRM527_Div2_L1_P8XMatrixTransformation
{
	public String solve(String[] original, String[] target)
	{
		...
		for (int i=0; i < original.length; i++)
            ...
            {
                if (original[i].charAt(j) == '1') oSum++;
                if (target[i].charAt(j) == '1') tSum++;
            }
	...
	private static boolean KawigiEdit_RunTest(int testNum, String[] p0, String[] p1, boolean hasAnswer, String p2) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM527_Div2_L1_P8XMatrixTransformation obj;
		String answer;
		obj = new SRM527_Div2_L1_P8XMatrixTransformation();

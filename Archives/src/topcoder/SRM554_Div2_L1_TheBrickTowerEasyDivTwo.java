...
public class SRM554_Div2_L1_TheBrickTowerEasyDivTwo
{
	public int find(int redCount, int redHeight, int blueCount, int blueHeight)
	{
		...
		for (int r = 0; r <= redCount; r++)
			for (int b = 0; b <= blueCount; b++)
				if (Math.abs(r-b) <= 1 && r+b > 0)
					ts.add(r*redHeight + b*blueHeight);
		return ts.size();
	...
	private static boolean KawigiEdit_RunTest(int testNum, int p0, int p1, int p2, int p3, boolean hasAnswer, int p4) {
		...
		System.out.println("]");
		SRM554_Div2_L1_TheBrickTowerEasyDivTwo obj;
		int answer;
		obj = new SRM554_Div2_L1_TheBrickTowerEasyDivTwo();

...
class ClsComparator implements Comparator<Integer>
{
	//compare method must be public and have two objects of type Integer (matching Comparator<>)
...
public class Comparator_SRM166_Div2_L2_BinaryCardinality_Cmp
{
	public int[] arrange(int[] numbers)
	{
		...
		Arrays.sort(nums, new ClsComparator());       //version 1 - separate class
		Arrays.sort(nums, new Comparator<Integer>()   //version 2 - embedded class
		{
			@Override
			public int compare(Integer a, Integer b)
			{
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, boolean hasAnswer, int[] p1) {
		...
		System.out.print("}");
		System.out.println("]");
		Comparator_SRM166_Div2_L2_BinaryCardinality_Cmp obj;
		int[] answer;
		obj = new Comparator_SRM166_Div2_L2_BinaryCardinality_Cmp();

...
public class Comparable_TCO2017_R2_L1_CanidsSeesaw
{
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, int[] p1, int p2, boolean hasAnswer, int[] p3) {
		...
		System.out.print("}" + "," + p2);
		System.out.println("]");
		Comparable_TCO2017_R2_L1_CanidsSeesaw obj;
		int[] answer;
		obj = new Comparable_TCO2017_R2_L1_CanidsSeesaw();

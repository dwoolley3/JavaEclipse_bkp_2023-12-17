...
public class SRM682_Div1_L1_SmilesTheFriendshipUnicorn_orig
{	
	ArrayList<Integer>[] g;
	boolean[] used;
	...
	private static boolean KawigiEdit_RunTest(int testNum, int p0, int[] p1, int[] p2, boolean hasAnswer, String p3) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM682_Div1_L1_SmilesTheFriendshipUnicorn_orig obj;
		String answer;
		obj = new SRM682_Div1_L1_SmilesTheFriendshipUnicorn_orig();

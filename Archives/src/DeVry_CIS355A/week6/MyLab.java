...
public class MyLab extends JFrame {
	...
	private Tab1JPanelIndex myJpan1;  // Tab 1
	private Tab2JPanelIndex2 myJpan2; // Tab 2
	private Tab3JPanelThreeArrayLists myJpan3; // Tab 3
	...
	public MyLab() {
		...
		myJpan1 = new Tab1JPanelIndex();
		myJpan2 = new Tab2JPanelIndex2();
		myJpan3 = new Tab3JPanelThreeArrayLists();
		myJpan1.setBackground(Color.cyan); //Set Tab 1 color
		myJpan2.setBackground(Color.cyan); //Set Tab 2 color
		myJpan2.setBackground(Color.cyan); //Set Tab 3 color
		...
		myJtp1.addTab("Index", myJpan1);  // (Character Finder) 
		myJtp1.addTab("Index2", myJpan2);
		myJtp1.addTab("Three Array Lists", myJpan3);
		...
		myJfrm1.setBounds(200,200, 350,660);

...
public class sp_SRM584_Div2_L2_Egalitarianism
{
	public int maxDifference(String[] isFriend, int d)
	{
        ...
        //Find maximum length of all shortest paths
        int max = 0;
        for (int i = 0; i < n; i++)
            for (int j = 0; j < i; j++)
            {
                if (graph[i][j] >= INF) return -1;
	...
	private static boolean KawigiEdit_RunTest(int testNum, String[] p0, int p1, boolean hasAnswer, int p2) {
		...
		System.out.print("}" + "," + p1);
		System.out.println("]");
		sp_SRM584_Div2_L2_Egalitarianism obj;
		int answer;
		obj = new sp_SRM584_Div2_L2_Egalitarianism();

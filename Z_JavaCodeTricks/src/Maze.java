...
class Maze
{
     ...
     *   here invoked Queue2 is shortest path.
     */
     ...
     * enQueue2 all children and deque them until it gets final point.
     */
    ...
    void solve() 
    {
        ...
        Queue2.enqueue(startCell, Q);
    
        while(!Queue2.is_empty(Q))
        {
            MazeCell CMC = (MazeCell)Queue2.dequeue(Q);
...
/*
 * The Queue2 class consists of two references:
 *   front, a reference to the first QCell in the queue,
 *          which is the first to go on a call to deQueue2.
...
class Queue2
{
   ...
   * A Queue2 is empty if either of its front
  ...
  public static boolean is_empty(Queue2 Q) 
  {
    return Q.is_empty();
  }
  
  /*
   * The static and nonstatic enQueue2 methods.
   * A new QCell is created and placed at the back of
   *   the Queue2. The previous back (if any)
  ...
  public static void enqueue(Object o, Queue2 Q)
  {
    Q.enqueue(o);  
  }
  
  /*
   * The static and nonstatic deQueue2 methods.
   * If there is only one QCell remaining, its data
   *   is returned and both the Queue's front and back are
   *   set to null, since the resulting Queue2 is empty.
  ...
  public static Object dequeue(Queue2 Q)
  {
    return Q.deQueue2();  
  }
   ...
   *            the Queue2 that invokes this method. It may be invoked implicitly
   *            when a Queue2 is an argument to the + operator and another String.
   */

  public String toString()
  {
    StringBuffer theFullAnswer = new StringBuffer();  // now it's ""
    theFullAnswer.append("The Queue2 (or derived class) is\n"); 
  ...
  public static void main(String[] arg)
  {
    ...
    System.out.println(Q);
    System.out.println("Q.deQueue2() is " + Q.deQueue2());
    System.out.println(Q);
    System.out.println("Q.deQueue2() is " + Q.deQueue2());
    System.out.println(Q);

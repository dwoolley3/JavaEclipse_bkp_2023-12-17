...
public class SRM647_Div1_L1_BuildingTowersEasy
{
	public int maxHeight(int N, int[] x, int[] t)
	{
		int[] maxh = new int[N];
		for (int i = 0; i < N; i++) maxh[i] = Integer.MAX_VALUE;
		maxh[0] = 0;
		for (int i = 0; i < x.length; i++)
			maxh[x[i]-1] = Math.min(maxh[x[i]-1], t[i]);
	...
	private static boolean KawigiEdit_RunTest(int testNum, int p0, int[] p1, int[] p2, boolean hasAnswer, int p3) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM647_Div1_L1_BuildingTowersEasy obj;
		int answer;
		obj = new SRM647_Div1_L1_BuildingTowersEasy();
	...
	public static void main(String[] args) {
		...
		// ----- test 3 -----
		p0 = 20;
		p1 = new int[]{4,7,13,15,18,20};
		p2 = new int[]{3,8,1,17,16,7};
		p3 = 7;
		all_right = KawigiEdit_RunTest(3, p0, p1, p2, true, p3) && all_right;
		// ------------------

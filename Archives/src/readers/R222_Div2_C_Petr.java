 ...
 */
public class R222_Div2_C_Petr {
	public static void main(String[] args) {
		InputStream inputStream = System.in;
		OutputStream outputStream = System.out;
		InputReader32 in = new InputReader32(inputStream);
		PrintWriter out = new PrintWriter(outputStream);
		TaskC222b solver = new TaskC222b();
...
class TaskC222b {
    ...
    public void solve(int testNumber, InputReader32 in, PrintWriter out) {
        height = in.nextInt();
        width = in.nextInt();
        int k = in.nextInt();
        int s = 0;
...
class InputReader32b {
    public BufferedReader reader;
    public StringTokenizer tokenizer;

    public InputReader32b(InputStream stream) {

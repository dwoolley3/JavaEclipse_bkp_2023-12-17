...
public class TCO2014_R1C_L2_FizzBuzzTurbo
{
	public long[] counts(long A, long B)
	{
		long d3=0, d5=0, d15=0;
		A--;
		
		d3 = (B/3 - B/15) - (A/3 - A/15);
		d5 = (B/5 - B/15) - (A/5 - A/15);
		d15 = B/15 - A/15;
		
		return new long[]{d3,d5,d15};
	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, long p0, long p1, boolean hasAnswer, long[] p2) {
		...
		System.out.println("]");
		TCO2014_R1C_L2_FizzBuzzTurbo obj;
		long[] answer;
		obj = new TCO2014_R1C_L2_FizzBuzzTurbo();

...
public class SRM600_Div2_L2_ORSolitaireDiv2
{
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, int p1, boolean hasAnswer, int p2) {
		...
		System.out.print("}" + "," + p1);
		System.out.println("]");
		SRM600_Div2_L2_ORSolitaireDiv2 obj;
		int answer;
		obj = new SRM600_Div2_L2_ORSolitaireDiv2();

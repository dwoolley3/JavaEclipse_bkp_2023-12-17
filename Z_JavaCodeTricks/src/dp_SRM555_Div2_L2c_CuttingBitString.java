...
public class dp_SRM555_Div2_L2c_CuttingBitString
{
    int INF = 1000;
	...
	private static boolean KawigiEdit_RunTest(int testNum, String p0, boolean hasAnswer, int p1) {
		...
		System.out.println("]");
		dp_SRM555_Div2_L2c_CuttingBitString obj;
		int answer;
		obj = new dp_SRM555_Div2_L2c_CuttingBitString();

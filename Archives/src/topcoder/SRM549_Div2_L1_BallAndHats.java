...
public class SRM549_Div2_L1_BallAndHats
{
	public int getHat(String hats, int numSwaps)
	{
		int hatPos = hats.indexOf("o");
        if (numSwaps == 0)
            return hatPos;
        else
            return (hatPos + numSwaps) % 2;
	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, String p0, int p1, boolean hasAnswer, int p2) {
		...
		System.out.println("]");
		SRM549_Div2_L1_BallAndHats obj;
		int answer;
		obj = new SRM549_Div2_L1_BallAndHats();

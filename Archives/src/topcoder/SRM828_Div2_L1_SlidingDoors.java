...
public class SRM828_Div2_L1_SlidingDoors
{
	...
	private static boolean KawigiEdit_RunTest(int testNum, int p0, String[] p1, int p2, boolean hasAnswer, String[] p3) {
		...
		System.out.print("}" + "," + p2);
		System.out.println("]");
		SRM828_Div2_L1_SlidingDoors obj;
		String[] answer;
		obj = new SRM828_Div2_L1_SlidingDoors();
		long startTime = System.currentTimeMillis();
		answer = obj.openSection(p0, p1, p2);

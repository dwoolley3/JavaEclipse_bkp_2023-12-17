...
public class dfs_matrix_component_SRM648_Div2_Lw_Fragile2
{	
	boolean[] used;
	int[] id;
	int cnt = 0;
	...
	private static boolean KawigiEdit_RunTest(int testNum, String[] p0, boolean hasAnswer, int p1) {
		...
		System.out.print("}");
		System.out.println("]");
		dfs_matrix_component_SRM648_Div2_Lw_Fragile2 obj;
		int answer;
		obj = new dfs_matrix_component_SRM648_Div2_Lw_Fragile2();

...
public class SRM161_Div2_L1_CardCount
{
	public String[] dealHands(int numPlayers, String deck)
	{
        int num = deck.length() / numPlayers;
        String[] s = new String[numPlayers];
        for (int i = 0; i < numPlayers; i++) s[i] = "";
        for (int i = 0; i < num * numPlayers; i++)
            s[i % numPlayers] += deck.charAt(i);
        return s;
	}
	...
	private static boolean KawigiEdit_RunTest(int testNum, int p0, String p1, boolean hasAnswer, String[] p2) {
		...
		System.out.println("]");
		SRM161_Div2_L1_CardCount obj;
		String[] answer;
		obj = new SRM161_Div2_L1_CardCount();

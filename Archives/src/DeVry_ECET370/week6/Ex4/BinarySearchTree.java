...
public class BinarySearchTree
{
    ...
    /**
     * Determines height of subtree
     * Note: Method gleaned from http://cslibrary.stanford.edu/110/BinaryTrees.html
     *
    ...
    private int getHeight(Node node)
    {
    	...
    	else
    	{
	    	...
	    	// The higher subtree is taken, plus 1

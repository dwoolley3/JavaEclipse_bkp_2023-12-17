...
public class Comparator_SRM166_Div2_L2_BinaryCardinality
{
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, boolean hasAnswer, int[] p1) {
		...
		System.out.print("}");
		System.out.println("]");
		Comparator_SRM166_Div2_L2_BinaryCardinality obj;
		int[] answer;
		obj = new Comparator_SRM166_Div2_L2_BinaryCardinality();

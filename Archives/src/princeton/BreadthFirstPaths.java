 ...
 *  Dependencies: Graph.java Queue2.java Stack.java StdOut.java
 ...
 *  Iter uses extra space (not including the graph) proportional to <em>V</em>.
 *  <p>
...
public class BreadthFirstPaths {
    ...
    public static void main(String[] args) {
        //In in = new In(args[0]);
        In in = new In("src/algs4-data/tinyCG.txt");

...
public class SRM166_Div2_L2_BinaryCardinality
{
	public int[] arrange(int[] numbers)
	{
		...
		for (int i = 0; i < n-1; i++)
			for (int j = i+1; j < n; j++)
			{
				a = Integer.bitCount(numbers[i]);
				b = Integer.bitCount(numbers[j]);
				if (a > b || a == b && numbers[i] > numbers[j])
				{
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, boolean hasAnswer, int[] p1) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM166_Div2_L2_BinaryCardinality obj;
		int[] answer;
		obj = new SRM166_Div2_L2_BinaryCardinality();

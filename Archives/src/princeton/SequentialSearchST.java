 ...
 *  Iter supports the usual <em>put</em>, <em>get</em>, <em>contains</em>,
 *  <em>delete</em>, <em>size</em>, and <em>is-empty</em> methods.
 *  Iter also provides a <em>keys</em> method for iterating over all of the keys.
 ...
 *  Iter relies on the <tt>equals()</tt> method to test whether two keys
 *  are equal. Iter does not call either the <tt>compareTo()</tt> or
...
public class SequentialSearchST<Key, Value> {
    ...
    public static void main(String[] args) {
        ...
        String[] st1 = new String[] {"Doug", "Craig", "Brad", "Egor"};
        for (int i = 0; i < 4; i++) {
            String key = st1[i];
            st.put(key, i);
        }

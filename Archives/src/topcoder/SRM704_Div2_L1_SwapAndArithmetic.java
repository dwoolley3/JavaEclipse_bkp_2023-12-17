...
public class SRM704_Div2_L1_SwapAndArithmetic
{
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, boolean hasAnswer, String p1) {
		...
		System.out.print("}");
		System.out.println("]");
		SRM704_Div2_L1_SwapAndArithmetic obj;
		String answer;
		obj = new SRM704_Div2_L1_SwapAndArithmetic();
	...
	public static void main(String[] args) {
		...
		// ----- test 3 -----
		p0 = new int[]{1000,704,1};
		p1 = "Impossible";
		all_right = KawigiEdit_RunTest(3, p0, true, p1) && all_right;
		// ------------------
		
		// ----- test 4 -----
		p0 = new int[]{7,3,11,5,1,9};
		p1 = "Possible";

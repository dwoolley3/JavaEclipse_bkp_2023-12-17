...
public class dfs_SRM682_Div1_L1_SmilesTheFriendshipUnicorn
{	
	ArrayList<Integer>[] g;
	boolean[] used;
	...
	private boolean dfs(int v, int depth) 
	{		
	...
	private static boolean KawigiEdit_RunTest(int testNum, int p0, int[] p1, int[] p2, boolean hasAnswer, String p3) {
		...
		System.out.print("}");
		System.out.println("]");
		dfs_SRM682_Div1_L1_SmilesTheFriendshipUnicorn obj;
		String answer;
		obj = new dfs_SRM682_Div1_L1_SmilesTheFriendshipUnicorn();

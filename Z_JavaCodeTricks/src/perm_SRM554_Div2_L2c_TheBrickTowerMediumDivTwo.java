...
public class perm_SRM554_Div2_L2c_TheBrickTowerMediumDivTwo
{
	private int[] ans, per;
	...
	private static boolean KawigiEdit_RunTest(int testNum, int[] p0, boolean hasAnswer, int[] p1) {
		...
		System.out.print("}");
		System.out.println("]");
		perm_SRM554_Div2_L2c_TheBrickTowerMediumDivTwo obj;
		int[] answer;
		obj = new perm_SRM554_Div2_L2c_TheBrickTowerMediumDivTwo();
